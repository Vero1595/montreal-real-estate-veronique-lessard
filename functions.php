...
function add_my_menus() {
    register_nav_menus(
    array(
        'header-menu' => __( 'Header Menu', 'montreal-real-estate-veronique-lessard' ),
        'footer-menu' => __( 'Footer Menu', 'montreal-real-estate-veronique-lessard' ),
        'social-menu' => __( 'Social Menu', 'montreal-real-estate-veronique-lessard'),
